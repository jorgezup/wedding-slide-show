...
const GOOGLE_DRIVE_JANTAR_FOLDER_ID = process.env.GOOGLE_DRIVE_JANTAR_FOLDER_ID || "";

export async function GET() {
  if (!GOOGLE_API_KEY || !GOOGLE_DRIVE_JANTAR_FOLDER_ID) {
  ...
  try {
    const query = `'${GOOGLE_DRIVE_JANTAR_FOLDER_ID}' in parents and mimeType contains 'image/' and trashed = false`;
